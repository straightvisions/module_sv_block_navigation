<?php
	...
	class sv_block_navigation extends init {
		public function init() {
			$this->set_module_title( __( 'Block: Navigation', 'sv100' ) )
				...
				->set_block_handle('wp-block-navigation')
				->set_block_name('core/navigation')
				->get_root()
				->add_section( $this );
		}
